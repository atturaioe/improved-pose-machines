...
from utils.transforms import get_affine_transform, gaussian, affine_transform
...
def main():
    ...
    pose_transform = transforms.Compose([
        transforms.ToTensor(), 
        transforms.Normalize(mean=[0.407, 0.444, 0.466],
    ...
    # write csv
    csv_headers = ['frame']
    for keypoint in MPII_KEYPOINT_INDICES.values():
